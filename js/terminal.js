const terminalData = [
    { text: "whoami   ", additionalMessage: "Name: Josh V. Cinense<br>    Age: 20 <br><br>    Creates things with the power of creativity and efficiency" },
  ];
    ...
    function typeText() {
      ...
      const intervalId = setInterval(() => {
        ...
        if (index === text.length) {
          ...
          extraMessageElement.innerHTML = terminal.additionalMessage;
          ...
          if (terminal.additionalMessage.trim() !== "") {
